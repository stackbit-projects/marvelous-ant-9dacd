...
1. Run the following command to fetch the content from Sanity:
        ...
        npx @stackbit/stackbit-pull --stackbit-pull-api-url=https://api.stackbit.com/pull/5fe9dacd9d5cc90015f53c1b
...
To start editing your site, you can use the Sanity interface at https://marvelous-ant-9dacd.sanity.studio/.
...
Generated at `2020-12-28T13:17:20.627Z` by Stackbit version `0.3.41`.